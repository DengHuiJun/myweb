...
<div id="body-wrapper">
  ...
  <!-- End #sidebar -->
    ...
    <div class = "addArticle">
		<h2>修改文章</h2>
    <hr />
		<form action="/myWeb/index.php/Admin/Article/doUpdate" method="post">    
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
             <input type="text" name = "id"  value="<?php echo ($m["id"]); ?>"  style="visibility:hidden">
            <p>
              <label>输入标题：</label>
              <input class="text-input small-input" type="text" value ="<?php echo ($m["title"]); ?>" id="small-input" name="title"  />
              <span class="input-notification success png_bg">Successful message</span>
              <!-- Classes for input-notification: success, error, information, attention -->      
            <p>
            <p>
              <label>输入作者：</label>
              <input class="text-input small-input" type="text" value ="<?php echo ($m["author"]); ?>" id="small-input" name="author" />
              <span class="input-notification success png_bg">Successful message</span>
              <!-- Classes for input-notification: success, error, information, attention -->      
            <p>
            <p>
              <label>输入摘要：</label>
              <input class="text-input small-input" type="text" value ="<?php echo ($m["info"]); ?>" id="small-input" name="info" />
              <span class="input-notification success png_bg">Successful message</span>
              <!-- Classes for input-notification: success, error, information, attention -->      
            <p>
            <p>
            ...
            <p>
              <label>输入状态码：</label>
              <input class="text-input small-input" type="text" value ="<?php echo ($m["code"]); ?>" id="small-input" name="code" />
              <span class="input-notification success png_bg">Successful message</span>
              <!-- Classes for input-notification: success, error, information, attention -->      
            <p>
