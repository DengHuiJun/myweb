...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <h1>The System of Zero In University</h1>
    <!-- Logo (221px width) -->
    <a href="#"><img id="logo" src="/myWeb/Public/Admin/Img/logo.png" alt="Simpla Admin logo" /></a> 
  </div>
  <!-- End #logn-top -->
  <div id="login-content">
    <form action="/myWeb/index.php/Admin/Manager/doLogin" method ="post" >
      <div class="notification information png_bg">
        <div>Welcome to Zero Web System!</div>
      </div>
      <p>
        <label>Username</label>
        <input class="text-input" type="username" name = "username"/>
      </p>
      <div class="clear"></div>
      <p>
