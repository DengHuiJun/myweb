...
<link href="__PUBLIC__/css/Album.css" rel="stylesheet">
	<div class ="posi">
        <span>本站位置</span>&nbsp;&nbsp;&gt;&gt;&nbsp;<a href="__APP__/Index/index">首页</a>&nbsp;&nbsp;&gt;&nbsp;<a href="__APP__/Album/index">团队风采</a>
    </div>

	<div class = "work_list">

		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$photofc): $mod = ($i % 2 );++$i;?><div class = "photos">
            	<center><img src="__UPLOAD__/m_<?php echo ($photofc["image"]); ?>" /></center>
